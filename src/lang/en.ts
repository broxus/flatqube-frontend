export default {
    ...
    GAUGE_BANNER_NEW_TITLE: 'Moving to new farming pools until November 26, 2022',
    GAUGE_BANNER_NEW_TEXT: 'You will be able to farm in the new pools instead of current (old) ones after November 26, 2022. <br /> Please, withdraw your LP tokens from the old farming pools and deposit them in the new ones before this time.',
    GAUGE_BANNER_OLD_TITLE: 'Moving to new farming pools until November 26, 2022',
    GAUGE_BANNER_OLD_TEXT: 'The current (old) farming pools stop generating income after November 26, 2022 and will be replaced by new farming pools. <br /> Please, withdraw your LP tokens from the old farming pools and deposit them in the new ones before this time.',
