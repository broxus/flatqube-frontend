            ...
            {() => {
                ...
                return (
                    <div className="list-bill">
                        ...
                        {(formStore.leftToken !== undefined && formStore.rightToken !== undefined && (
                            <>
                                ...
                                <div key="pairRoot" className="list-bill__row">
                                    ...
                                    <div className="list-bill__val">
                                        ...
                                        {isSyncingPool ? (
                                            <Placeholder height={18} width={80} />
                                        ) : formStore.pool?.address === undefined ? <>&mdash;</> : (
                                            <AccountExplorerLink address={formStore.pool.address.toString()} />
                                        )}
                                    </div>
                                </div>
                            </>
