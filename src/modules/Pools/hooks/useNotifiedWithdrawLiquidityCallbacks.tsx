...
import type { LiquidityStablePoolWithdrawCallbacks } from '@/misc'
...
export function useNotifiedWithdrawLiquidityCallbacks(
    props: LiquidityStablePoolWithdrawCallbacks,
    ...
    const onSend = React.useCallback<Required<LiquidityStablePoolWithdrawCallbacks>['onSend']>((message, params) => {
        onSendCallback?.(message, params)
        notify(
            <div className="notification-body">
                {intl.formatMessage({ id: 'LIQUIDITY_ADD_NOTIFICATION_PENDING_WITHDRAW_LIQUIDITY_NOTE' })}
            </div>,
            intl.formatMessage({ id: 'LIQUIDITY_ADD_NOTIFICATION_PENDING_WITHDRAW_LIQUIDITY_TITLE' }),
            {
                autoClose: false,
                closeOnClick: false,
                isLoading: true,
    ...
    const onTransactionSuccess = React.useCallback<Required<LiquidityStablePoolWithdrawCallbacks>['onTransactionSuccess']>(result => {
        onTransactionSuccessCallback?.(result)

        notify(
            <>
                <div className="notification-body">
                    {intl.formatMessage({ id: 'LIQUIDITY_ADD_NOTIFICATION_SUCCESS_WITHDRAW_LIQUIDITY_NOTE' })}
                </div>
                <div
            ...
            intl.formatMessage({ id: 'LIQUIDITY_ADD_NOTIFICATION_SUCCESS_WITHDRAW_LIQUIDITY_TITLE' }),
            {
                closeOnClick: true,
                isLoading: false,
    ...
    const onTransactionFailure = React.useCallback<Required<LiquidityStablePoolWithdrawCallbacks>['onTransactionFailure']>(reason => {
        ...
        notify(
            ...
            intl.formatMessage({ id: 'LIQUIDITY_ADD_NOTIFICATION_FAILURE_WITHDRAW_LIQUIDITY_TITLE' }),
            {
                closeOnClick: true,
                isLoading: false,
