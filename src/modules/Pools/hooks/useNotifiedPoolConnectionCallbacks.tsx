...
import type { LiquidityStablePoolConnectCallbacks } from '@/misc'
...
export function useNotifiedPoolConnectionCallbacks(
    props: LiquidityStablePoolConnectCallbacks,
    ...
    const onSend = React.useCallback<Required<LiquidityStablePoolConnectCallbacks>['onSend']>((message, params) => {
    ...
    const onTransactionSuccess = React.useCallback<Required<LiquidityStablePoolConnectCallbacks>['onTransactionSuccess']>(result => {
    ...
    const onTransactionFailure = React.useCallback<Required<LiquidityStablePoolConnectCallbacks>['onTransactionFailure']>(reason => {
