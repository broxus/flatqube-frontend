...
import type { DexAccountWithdrawTokenCallbacks, LiquidityStablePoolTokenData } from '@/misc'
...
export function useNotifiedWithdrawTokenCallbacks(props: DexAccountWithdrawTokenCallbacks): WithdrawTokenCallbacks {
    ...
    const onTransactionFailure = React.useCallback<Required<WithdrawTokenCallbacks>['onTransactionFailure']>(reason => {
