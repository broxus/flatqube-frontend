...
export function GaugesBannerNew(): JSX.Element | null {
    const intl = useIntl()
    ...
    const hide = () => {
        storage.set('gauges-banner-new-closed', '1')
        setVisible(false)
    }
    ...
    return (
        <div className={`${styles.banner} ${styles.new}`}>
            <button
                type="button"
