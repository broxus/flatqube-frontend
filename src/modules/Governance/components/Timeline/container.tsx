...
import { Day } from '@/modules/Governance/components/Timeline/day'
import { Line } from '@/modules/Governance/components/Timeline/line'
import { Interval } from '@/modules/Governance/components/Timeline/interval'
...
export function Container({
    ...
    return (
        <div className="card card--flat card--xsmall timeline">
