        ...
        <div className="list__card">
            <div className="list-bill">
                    ...
                    <div className="list-bill__info">
                        ...
                        <div
                            className={classNames('label', {
                                'label--danger': transaction.eventType === CurrencyTransactionEventType.Withdraw,
                                'label--success': transaction.eventType === CurrencyTransactionEventType.Deposit,
                            })}
                        >
                            {intl.formatMessage({
                ...
                <Observer>
                    {() => {
                        switch (true) {
                            case currencyTransactionsStore.isSyncingCustomTokens:
                                return (
                            ...
                            case transaction.eventType === CurrencyTransactionEventType.Swap: {
                                ...
                                return (
                                    <>
                                        ...
                                        >
                                            <div className="list-bill__info">
                                                {intl.formatMessage({
                                                    id: 'CURRENCY_TRANSACTIONS_LIST_HEADER_SPENT_TOKEN_CELL',
                                                })}
                                            </div>
                                            <div
                                        ...
                                        >
                                            <div className="list-bill__info">
                                                {intl.formatMessage({
                                                    id: 'CURRENCY_TRANSACTIONS_LIST_HEADER_RECEIVED_TOKEN_CELL',
                                                })}
                                            </div>
                                            <div
                                                className="list-bill__val"
                            ...
                            default:
                                return (
                                    <div className="list-bill__row" style={{ alignItems: 'flex-start' }}>
                                        <div className="list-bill__info">
                                            {intl.formatMessage({
                                                id: 'CURRENCY_TRANSACTIONS_LIST_HEADER_TOKENS_CELL',
                                            })}
                                        </div>
                                        <div
                                            className="list-bill__val"
