...
export function Loader(): JSX.Element {
    const firstFilterId = React.useRef(uniqueId())
    const secondFilterId = React.useRef(uniqueId())
    return (
        <svg
        ...
        >
            ...
            <defs>
                ...
                >
                    ...
                    <feColorMatrix type="matrix" values="0 0 0 0 0.772549 0 0 0 0 0.894118 0 0 0 0 0.952941 0 0 0 1 0" />
