...
export function SwapTransactionsListEmpty(): JSX.Element {
    const intl = useIntl()
    ...
    return (
        <div className={styles.list__empty_message}>
            ...
            <h3 className={styles.list__empty_message__title}>
                {intl.formatMessage({ id: 'POOL_TRANSACTIONS_LIST_EMPTY' })}
            </h3>
            <div className={styles.list__empty_message__note}>
                {intl.formatMessage({ id: 'POOL_TRANSACTIONS_LIST_EMPTY_NOTE' })}
            </div>
        </div>
    )
}
