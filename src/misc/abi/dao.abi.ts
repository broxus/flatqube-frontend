export class DaoAbi {
    ...
    static Root = {
        ...
        functions: [
            ...
            {
                name: 'expectedVoteEscrowAccountAddress',
                inputs: [
                    { name: 'answerId', type: 'uint32' },
            ...
            {
                name: 'setVoteEscrowRoot',
                inputs: [
                    { name: 'newVoteEscrowRoot', type: 'address' },
                ],
                outputs: [
                ],
            },
            ...
            },
            {
                ...
                outputs: [
                    { name: 'voteEscrowRoot', type: 'address' },
                ],
            },
            {
